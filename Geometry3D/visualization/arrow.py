...
class Arrow:
    ...
    def __eq__(self, other):
        return (
            abs(self.x - other.x) < get_eps()
            and abs(self.y - other.y) < get_eps()
            and abs(self.z - other.z) < get_eps()
            and abs(self.u - other.u) < get_eps()
            and abs(self.v - other.v) < get_eps()
            and abs(self.w - other.w) < get_eps()
            and abs(self.length - other.length) < get_eps()
        )
