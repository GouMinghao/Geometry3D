    ...
    **Output:**
    ...
    if isinstance(a, Line) and isinstance(b, Line):
        ...
        raise NotImplementedError(
            "Not implement angle function between %s and %s" % (type(a), type(b))
        )
...
def parallel(a, b):
    ...
    **Output:**
    ...
    if isinstance(a, Line) and isinstance(b, Line):
        ...
        raise NotImplementedError(
            "Not implement parallel function between %s and %s" % (type(a), type(b))
        )
...
def orthogonal(a, b):
    ...
    **Output:**
    ...
    if isinstance(a, Line) and isinstance(b, Line):
        ...
        raise NotImplementedError(
            "Not implement orthogonal function between %s and %s" % (type(a), type(b))
        )
