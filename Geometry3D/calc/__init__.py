...
from .aux_calc import get_projection_length,get_relative_projection_length,get_segment_from_point_list,get_segment_convexpolyhedron_intersection_point_set,get_segment_convexpolygen_intersection_point_set,points_in_a_line,get_halfline_convexpolyhedron_intersection_point_set
